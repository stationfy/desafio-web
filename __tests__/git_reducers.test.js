import reducer from "../src/reducers/git_reducer";
import {
  FETCH_REPOSITORIES,
...
import { fetchRepositories } from "../src/actions/git_action";
...
const dataPullRequests = [
  {
    ...
    patch_url: "https://github.com/freeCodeCamp/freeCodeCamp/pull/16708.patch",
    issue_url:
    ...
    user: {
      ...
      gists_url: "https://api.github.com/users/ahmadabdolsaheb/gists{/gist_id}",
      starred_url:
...
describe("get reducer", () => {
  ...
  it("should return the pullRequests", () => {
    expect(
      reducer(initialState, {
        ...initialState,
        pullRequests: dataPullRequests
      })
    ).toMatchSnapshot();
  });
});
